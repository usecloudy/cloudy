...
# BRAIN FOG INC. PRIVACY POLICY

Brain Fog Inc. (the “Company”) is committed to maintaining robust privacy protections for its
users. Our Privacy Policy (“Privacy Policy”) is designed to help you understand how we
...
accessed at [https://usecloudy.com](https://usecloudy.com).
“Service” refers to the Company's services accessed via the Site, in which users can use to
write and store notes and documents.
The terms “we,” “us,” and “our” refer to the Company.
“You” refers to you, as a user of our Site or our Service.
By accessing our Site or our Service, you accept our Privacy Policy and Terms of Use
(found here: [http://usecloudy.com/tos](http://usecloudy.com/tos)) and you consent to our collection, storage, use and
...
submit and number of clicks. **Personal Information** includes your email address and full name,
...
1. **Information collected via Technology**
   ...
   utilizing our services, both on an individual and aggregate basis. For example, the Company
   ...
   expire when you close your browser. For example, we store a persistent cookie to track
   your login status.
...
3. **Children's Privacy**
   ...
   have collected such information, please contact us at [info@usecloudy.com](mailto:info@usecloudy.com).
...
communications from us in the app.usecloudy.com/settings page of the Site. Please note that
notwithstanding the promotional preferences you indicate by either unsubscribing or opting
out in the settings page of the Site, we may continue to send you administrative emails
...
contact us by sending an email to info@usecloudy.com.
Last Updated: This Privacy Policy was last updated on August 14th 2024.

Email: [info@usecloudy.com](mailto:info@usecloudy.com)

Website: [usecloudy.com](https://usecloudy.com)`;

export default function PpPage() {
	return (
		<div className="mx-auto pt-24 px-6 max-w-screen-md pb-24">
			<Markdown className="prose">{privacyPolicyMd}</Markdown>
		</div>
	);
}
